...
import { defaultLayoutService } from '../../layout/services/LayoutServiceBridge';
...
export const useNodeOperations = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('layoutUpdated', handleLayoutUpdated);
    
    return () => {
      window.removeEventListener('layoutUpdated', handleLayoutUpdated);
    };
  }, []);
