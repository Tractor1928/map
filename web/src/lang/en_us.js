export default {
  ...
  ai: {
    ...
    VolcanoArkLargeModelConfiguration: 'DeepSeek Model Configuration:',
    configTip:
      'The app now uses DeepSeek API service. Please get your API key from the DeepSeek platform. For detailed steps, please refer to:',
    course: 'Course',
    ...
    modelValidateTip: 'Please enter the model name (e.g. deepseek-chat)',
