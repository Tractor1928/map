export default {
  ...
  ai: {
    ...
    VolcanoArkLargeModelConfiguration: 'Cấu hình mô hình DeepSeek:',
    configTip:
      'Ứng dụng hiện sử dụng dịch vụ API DeepSeek. Vui lòng lấy API key từ nền tảng DeepSeek. Để biết các bước chi tiết, vui lòng tham khảo:',
    course: 'Khóa học',
    ...
    modelValidateTip: 'Vui lòng nhập tên mô hình (ví dụ: deepseek-chat)',
