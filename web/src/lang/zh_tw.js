export default {
  ...
  ai: {
    ...
    VolcanoArkLargeModelConfiguration: 'DeepSeek 模型配置：',
    configTip: '目前使用 DeepSeek API 服務，請先在 DeepSeek 平台取得 API Key，詳細操作步驟見：',
    course: '教程',
    ...
    modelValidateTip: '請輸入模型名稱（例如 deepseek-chat）',
